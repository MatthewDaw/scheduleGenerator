...
$iparr = split ("findNumber=", $_GET['source']); 
    ...
    for ($i = 1; $i < sizeof($pageArray); $i ++)
    {
        ...
        if (substr($tempName2[0], 0, 5) == "Appoi")
        {
            $finalString = "";
            //echo $tempName2[0];
            $tempArray = explode("Appointed ", $tempName2[0]);
            //$finalString;
        ...
        //district
        $tempName1 = explode('"district":"',$pageArray[$i]);
        $tempName2 = explode('","service',$tempName1[1]);
        //$senNameArray[$i] = $tempName2[0];
        fwrite($myfile, $tempName2[0]);
        fwrite($myfile, "%");
...
for ($j = 0; $j < (sizeof($tempcommitteitem)-2); $j++){
    ...
    //finantial Report URL
        ...
        //position
        $tempName1 = explode('position":"',$pageArray[$i]);
        $tempName2 = explode('","distr',$tempName1[1]);
        //$senNameArray[$i] = $tempName2[0];
        fwrite($myfile, $tempName2[0]);
        fwrite($myfile, "%");
