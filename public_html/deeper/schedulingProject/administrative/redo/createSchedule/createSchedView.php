...
else
{
 ...
 ?>
    ...
    <div class="pull-xs-right">
        ...
        <a href='http://79.170.40.172/matthewbradleydaw.com/deeper/schedulingProject/administrative/redo/'><button class="btn btn-success-outline" type="submit">Create Schedule</button></a>
