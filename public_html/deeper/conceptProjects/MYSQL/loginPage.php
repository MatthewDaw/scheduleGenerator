    ...
    if (array_key_exists("submit", $_POST)) {
        ...
        if ($error != "") {
            ...
            if ($_POST['signUp'] == '1') {
                ...
                $query = "SELECT id FROM `students` WHERE username = '".mysqli_real_escape_string($link, $_POST['username'])."' LIMIT 1";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    if (!mysqli_query($link, $query)) {
                        ...
                        $query = "UPDATE `students` SET password = '".md5(md5(mysqli_insert_id($link)).$_POST['password'])."' WHERE id = ".mysqli_insert_id($link)." LIMIT 1";
                    ...
                    $query = "SELECT * FROM `students` WHERE username = '".mysqli_real_escape_string($link, $_POST['username'])."'";
