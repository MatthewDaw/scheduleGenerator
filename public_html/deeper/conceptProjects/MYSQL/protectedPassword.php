<?php
    ...
    $salt = "dsphe3891hj34yhjklbv nmdgsjklasdgs"; //add randome string in from a password to make it complicated

$row['id'] = 73; //use this as salt so that everything has different salt
                 //use something fixed like id

    echo md5($salt."password"); //stores password as complicated string
